...
const FILTERS: Filter[] = ['portraits', 'still-life', 'landscapes', 'all'];
...
export default function Gallery({ dark }: Props) {
  const [filter,      setFilter]      = useState<Filter>('portraits');
  const [displayList, setDisplayList] = useState<Photo[]>(portraitPhotos);
